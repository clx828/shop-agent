...
class MetaKnowledgeService:
    ...
    async def _save_tables_to_meta_db(
        ...
        async with self.meta_mysql_repository.session.begin():
            await self.meta_mysql_repository.clear_column_infos()
            await self.meta_mysql_repository.clear_table_infos()
    ...
    async def _save_metrics_to_meta_db(
        ...
        async with self.meta_mysql_repository.session.begin():
            await self.meta_mysql_repository.clear_column_metrics()
